...
type Point struct {
	...
	Speed     *float32               `protobuf:"fixed32,3,opt,name=speed" json:",omitempty" bson:",omitempty"`
	// float speed = 3;
	EntrySource      *string   `protobuf:"bytes,4,opt,name=entry_source,json=entrySource" json:"entry_source,omitempty"`
	Altitude         *float32  `protobuf:"fixed32,5,opt,name=altitude" json:",omitempty" bson:",omitempty"`
	Loc              *Geometry `protobuf:"bytes,8,opt,name=loc" json:"loc,omitempty"`
	ActivityType     *string   `protobuf:"bytes,9,opt,name=activity_type,json=activityType" json:",omitempty" bson:",omitempty"`
	Heading          *float32  `protobuf:"fixed32,11,opt,name=heading" json:",omitempty" bson:",omitempty"`
	Accuracy         *float32  `protobuf:"fixed32,12,opt,name=accuracy" json:",omitempty" bson:",omitempty"`
	AltitudeAccuracy *float32  `protobuf:"fixed32,13,opt,name=altitude_accuracy,json=altitudeAccuracy" json:",omitempty" bson:",omitempty"`
}
