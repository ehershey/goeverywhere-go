...
func (c *gOEClient) GetStats(ctx context.Context, in *StatsRequest, opts ...grpc.CallOption) (*StatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, GOE_GetStats_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedGOEServer must be embedded to have
...
func (UnimplementedGOEServer) testEmbeddedByValue()             {}
...
func RegisterGOEServer(s grpc.ServiceRegistrar, srv GOEServer) {
	// If the following call pancis, it indicates UnimplementedGOEServer was
